     ...
     function DisplStep3() {
       ...
       for (var i = 0; i < rcmAvailableCars.length; ++i) {
         ...
         if (rcmTaxInclusive == false) {
           ...
           out = out + "<div class='row'><div class='col-xs-6 text-left'><h4 class="subtotal">Total: </h4></div><div class='col-xs-6 text-right'><h4><label id='displTot'>###.##</label></h4></div></div>";
				 } else {
            ...
            <!--<div id="progress-bar">
              <div id="progress-bar-steps">
                ...
                <div class="progress-bar-step done" id="Imhere">
                    <a href="<?php echo site_url(); ?>/step2.php">
                  ...
                  <div class='col-sm-12'>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="col-sm-6"><input type="text" placeholder="License No..." class="form-license form-control" name="license" id="license" maxlength="15" value='<?php echo $_SESSION['api']["license"]; ?>' /></div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="col-sm-6"><input type="text" placeholder="Address..." class="form-address form-control col-sm-6" name="address" id="address" maxlength="50" value='<?php echo $_SESSION['api']["address"]; ?>' /></div>
                      </div>
                      <div class="col-sm-6">
                        <div class="col-sm-6"><label class="control-label">City :</label></div>
                        <div class="col-sm-6"><input type="text" placeholder="City..." class="form-city form-control col-sm-6" name="city" id="city" size="20" maxlength="20" value='<?php echo $_SESSION['api']["city"]; ?>' /></div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="col-sm-6"><label class="control-label">State :</label></div>
                        <div class="col-sm-6"><input type="text" placeholder="State..." class="form-state form-control col-sm-6" name="txtState" id="txtState" maxlength="15" value='<?php echo $_SESSION['api']["txtState"]; ?>' /></div>
                      </div>
                      <div class="col-sm-6">
                        <div class="col-sm-6"><label class="control-label">Postcode/ZIP :</label></div>
                        <div class="col-sm-6"><input type="text" placeholder="Postcode/ZIP..." class="form-postcode form-control col-sm-6" name="postcode" id="postcode" maxlength="10" value='<?php echo $_SESSION['api']["postcode"]; ?>' /></div>
                      </div>
                    </div>
