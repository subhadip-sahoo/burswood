    ...
    <div class="inner-bg">
      ...
      <div class="row">
        ...
        <div class="row" style="margin-top:5px;">
          ...
          <div class="col-sm-12 form-bottom step3-carsdetails">
          
          
              <div class="row"  style="background-color: white; border-radius: 5px; padding-top: 5px; padding-bottom: 5px;">
