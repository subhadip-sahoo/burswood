...
Partial Class FooterHome
  ...
  Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
    ...
    '<ContactDetails><CompanyContactDetails><Error>Please enter a valid Company ID.</Error></CompanyContactDetails></ContactDetails>
    'Check the eror Element List
    m_node = xDocResponse.SelectSingleNode("ContactDetails/CompanyContactDetails/Error")
    ...
    '<ContactDetails><ErrorDetails><Error>Error:18. Please contact customer care in case you receive this error</Error></ErrorDetails></ContactDetails>
    m_node = xDocResponse.SelectSingleNode("ContactDetails/ErrorDetails/Error")
    If IsNothing(m_node) = False Then
      'Get the ErrorCode Element Value
      sErrorCode = m_node.ChildNodes.Item(0).InnerText
      'Session("ErrorMsg") = sErrorCode
