            ...
            <div class="form-bottom">
              <form id="frmStep2" role="form" name="frmStep2" action="step3.php" method="post">
                ...
                <div class="row">
                  ...
                  <input type="radio" name="form-Minimum-Age1" value="8" <?php if($_SESSION["Age"]=='8'){?> checked="checked" <?php }?> onclick="document.getElementById('cmbAge').value=this.value"/>
                  <input type="radio" name="form-Minimum-Age1" value="9" <?php if($_SESSION["Age"]=='9'){?> checked="checked" <?php }?> onclick="document.getElementById('cmbAge').value=this.value"/>  
                   <input type='hidden1' name="form-Minimum-Age"  id='cmbAge' value='<?php echo $_SESSION["Age"];?>'>

                 <?php /*<select id="cmbAge" name="form-Minimum-Age" class="col-sm-12 form-control" onchange="getLocations()">
                      <!--<option value="" disabled selected>Select your Pickup Location</option>-->
                    </select> */?>
                  </div>
