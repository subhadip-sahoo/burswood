...
//session_start();
   ...
   tst.Add("email", "")
   tst.Add("phone", "")
   If Not IsNothing(Session(tst("Key"))) Then
      tst = Session(tst("Key"))
   Else
      Session(tst("Key")) = tst
   End If*/
   
   //$tst = array("Volvo", "BMW", "Toyota");
...
<head>
  ...
  <script src="include/jquery.datetimepicker.js"></script>
   ...
   <script src="https://secure20.rentalcarmanager.com.au/api/3.0/main/<?php echo $tst['Key'];?>" type="text/javascript"></script>
    ...
    function DisplStep1() {
      oAPI.LoadCategoryType(document.getElementById("cmbCatType"), '<?php echo $tst['CategoryTypeID'];?>');
      oAPI.LoadAgeList(document.getElementById("cmbAge"), '<?php echo $tst['Age'];?>');
      oAPI.LoadLocationsList(document.getElementById("cmbPickup"), document.getElementById("cmbDropOff"), document.getElementById("cmbAge"), '<?php echo $tst['PickupLocationID']?>', '<?php echo $tst['DropOffLocationID'];?>');
      ...
      $('#txtPickupTime').val('<?php echo $tst['PickupTime'];?>' == '' ? "10:00" : '<?php echo $tst['PickupTime']?>');
      ...
      $('#txtReturnTime').val('<?php echo $tst['ReturnTime'];?>' == '' ? "10:00" : '<?php echo $tst['ReturnTime'];?>');
      ...
      $('#txtPickup').val('<?php echo $tst['PickupDate'];?>' == '' ? rcmGetdate(startPickup) : '<?php echo $tst['PickupDate'];?>');
      ...
      $('#txtReturn').val('<?php echo $tst['ReturnDate'];?>' == '' ? rcmGetdate(startDropOff) : '<?php echo $tst['ReturnDate'];?>');
      var PickUpDW = 0;
      var DropOffDW = 0;
