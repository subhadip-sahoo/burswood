 ...
 <%
   If Request.QueryString("reset") = 1 Then Session.Abandon()
  ...
  tst.Add("Key", "V1VraUF0SVBKZkNaZTlLWDltVERzUT09")
   ...
   If (Trim(Request.Form("form-Category-Type")) <> "") Then tst("CategoryTypeID") = Request.Form("form-Category-Type")
   If (Trim(Request.Form("form-Pickup-Location")) <> "") Then tst("PickupLocationID") = Request.Form("form-Pickup-Location")
   If (Trim(Request.Form("form-Dropoff-Location")) <> "") Then tst("DropOffLocationID") = Request.Form("form-Dropoff-Location")
   If (Trim(Request.Form("form-Pickup-Date")) <> "") Then tst("PickupDate") = Request.Form("form-Pickup-Date")
   If (Trim(Request.Form("form-Pickup-Time")) <> "") Then tst("PickupTime") = Request.Form("form-Pickup-Time")
   If (Trim(Request.Form("form-Dropoff-Date")) <> "") Then tst("ReturnDate") = Request.Form("form-Dropoff-Date")
   If (Trim(Request.Form("form-Dropoff-Time")) <> "") Then tst("ReturnTime") = Request.Form("form-Dropoff-Time")
   If (Trim(Request.Form("form-Minimum-Age")) <> "") Then tst("Age") = Request.Form("form-Minimum-Age")
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
       ...
       if (window.history && window.history.pushState) {
         window.history.pushState('forward', null, './Step2.aspx');
     ...
     function DisplStep2() {
       ...
       if (document.getElementById("txtPickup").value == '__/__/____' && '<%=tst("PickupDate")%>' == '') $('#txtPickup').val(rcmGetdate(startPickup));
        ...
        if (document.getElementById("txtReturn").value == '__/__/____' && '<%=tst("ReturnDate")%>' == '') $('#txtReturn').val(rcmGetdate(startDropOff));
        var PickUpDW = 0;
        var DropOffDW = 0;
        ...
        <div class="row">
          <div class="col-sm-12 form-box">
            <div class="form-bottom">
              <form id="frmStep2" role="form" name="frmStep2" action="Step3.aspx" method="post">
                <div class="row">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="form-Pickup-Date" value='<%=tst("PickupDate")%>' placeholder="Pickup-Date..." class="form-control col-sm-12" id="txtPickup" autocomplete="off">
                  </div>
                  <div class="col-sm-2">
                    <input type="text" name="form-Pickup-Time" value='<%=tst("PickupTime")%>' placeholder="Pickup-Time..." class="form-control col-sm-12" id="txtPickupTime" autocomplete="off">
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="form-Dropoff-Date" value='<%=tst("ReturnDate")%>'  placeholder="Dropoff-Date..." class="form-control col-sm-12" id="txtReturn" autocomplete="off">
                  </div>
                  <div class="col-sm-2">
                    <input type="text" name="form-Dropoff-Time" value='<%=tst("ReturnTime")%>' placeholder="Dropoff-Time..." class="form-control col-sm-12" id="txtReturnTime" autocomplete="off">
                  </div>
                </div>
